...
VALUES  ('Michael Jackson', 'Thriller', 1982, 47.3, 'Pop' 'Rock' 'R&B'),
        ...
        ('Pink Floyed', 'The Dark Side Of The Moon', 1973, 24.2, 'Progressive Rock'),
        ('Meat Loaf', 'Bat Out Of Hell', 1977, 21.5, 'Hard Rock' 'Progressive Rock'),
        ('Whitney Houston' 'Various Artist', 'The Bodyguard', 1992, 28.4, 'R&B' 'Soul' 'Pop' 'Soundtrack'),
        ('Eagles', 'Their Greatest Hits 1971-1975', 1976, 32.2, 'Rock' 'Soft' 'Rock' 'Folk Rock'),
        ('Bee Gees' 'Various Artist', 'Saturday Night Fever', 1977, 21.6, 'Disco' 'Soundtrack'),
        ('Fleetwood Mac', 'Rumours', 1977, 27.9, 'Soft Rock'),
        ('Various Artist', 'Grease: The Original Soundtrack From The Motion Picture', 1978, 14.4, 'Soundtrack'),
        ('Led Zepplin', 'Led Zepplin IV', 1971, 29.0, 'Hard Rock' 'Heavy Metal' 'Folk'),
